...
# The number of bins and the suitable bins have been defined 
# All the data points are converted to categorical for prediction 
# out_dist measure has been used for prediction (distance predictions)
