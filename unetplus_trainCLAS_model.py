...
def train(infile, modelfile, suffix = "", 
    ...
    if binary_cutoffs:
        ...
        checkpoint = ModelCheckpoint(model_path, monitor='out_dist_mask_loss', verbose=1, save_best_only=False, mode='min')
    ...
    model.fit_generator(training_generator, num_steps, epochs=epochs, verbose=verbose,
                        ...
                        callbacks=[reduce_lr, csv_logger, checkpoint, earlystop, tb])
